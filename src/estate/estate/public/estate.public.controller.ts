...
import {
  WebEstateFilteringDto,
  WebEstateSortingDto
} from './dto/estateQuery.dto';
...
export class EstatePublicController {
  ...
  @Get('myEstates')
  @ApiOperation({
    summary: 'Get list of my estates',
    description: 'No Description'
  })
  @ApiResponse({ status: 200 })
  myEstates(
    @Query('filter') filter: WebEstateFilteringDto,
    @Query('sort') sort: WebEstateSortingDto,
  ...
  @Get()
  @ApiOperation({
    summary: 'Get list of Model with filtering',
    description: 'No Description'
  })
  @ApiResponse({ status: 200 })
  findAll(
